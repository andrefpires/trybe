...
Salve os pokémons favoritados no local storage e recupere-os quando a aplicação for inicializada.Esse é um projeto para o conteúdo de `React Router Dom`.
