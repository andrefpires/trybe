...
describe('Implemente a função animalMap', () => {
  ...
  it.skip('Com a opção `includeNames: true` especificada, retorna nomes de animais', () => {
  ...
  it.skip('Com a opção `sorted: true` especificada, retorna nomes de animais ordenados', () => {
